...
# Load predicted data
paths = {
    'Real Data': 'new_exp_pred/pred_results/LGB_real_pred_results_1.0.pickle',
    'GMMs': 'new_exp_pred/pred_results/LGB_gmm_pred_results_1.0.pickle',
    'FCPflow': 'new_exp_pred/pred_results/LGB_flow_pred_results_1.0.pickle',
    't-Copula': 'new_exp_pred/pred_results/LGB_copula_pred_results_1.0.pickle'
}
...
for name, data in datasets.items():
    plt.plot(data[index:index+48].T, label=name, color=color_map[name], linestyle=linestyles[name])
